...
export const ChatArea: React.FC<ChatAreaProps> = ({
  ...
  return (
    <div className="flex-1 flex flex-col h-full max-h-full bg-[#0F172A] relative overflow-hidden min-w-0">
      {/* Export & Actions Top Sub-header */}
      {messages.length > 0 && (
        <div className="px-6 py-2 bg-[#0B1120]/60 border-b border-slate-800/80 flex items-center justify-between text-xs text-slate-400 flex-shrink-0">
      ...
      {/* Main Messages Feed */}
      <div className="flex-1 overflow-y-auto p-4 md:p-6 space-y-6 max-w-4xl mx-auto w-full min-h-0">
        {messages.length === 0 ? (
